...
async function createBandingAddOn() {
  ...
  const subOptions = [
    ...
    },
    {
      ...
      isRequired: true,
      affectsPricing: true,
      tooltipText: 'Please enter the amount you want in each bundle. If you ordered 5000 quantity and entered 50, you would get 100 bundles.',
      displayOrder: 1
    }
  ];
  ...
  console.log(`Price:         $${finalAddOn.configuration.pricePerUnit}/${finalAddOn.configuration.unitName}`);
