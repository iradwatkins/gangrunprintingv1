...
async function addSizeModule() {
  ...
  try {
    ...
    console.log('=====================================');
    console.log('✅ Quantity Module:', updatedProduct.productQuantityGroups.length > 0 ? 'ENABLED' : 'DISABLED');
    ...
    console.log('✅ Size Module:', updatedProduct.productSizeGroups.length > 0 ? 'ENABLED' : 'DISABLED');
    ...
    console.log('❌ Paper Stock Module:', updatedProduct.productPaperStockSets.length > 0 ? 'ENABLED' : 'DISABLED (Correct!)');
    console.log('❌ Add-On Module:', updatedProduct.productAddOnSets.length > 0 ? 'ENABLED' : 'DISABLED (Correct!)');
    console.log('❌ Turnaround Module:', updatedProduct.productTurnaroundTimeSets.length > 0 ? 'ENABLED' : 'DISABLED (Correct!)');
...
addSizeModule()
  .then(result => {
    if (result.success) {
      ...
      console.log('Product URL: https://gangrunprinting.com/products/business-cards-quantity-only-test-1759153813144');
    } else {
