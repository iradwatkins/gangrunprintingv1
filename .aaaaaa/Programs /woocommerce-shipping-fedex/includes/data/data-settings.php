...
return array(
	...
	'tax_status'      => array(
		'title'       => __( 'Tax Status', 'woocommerce-shipping-fedex' ),
		'type'        => 'select',
		'description' => '',
		'default'     => 'taxable',
		'options'     => array(
			'taxable' => __( 'Taxable', 'woocommerce-shipping-fedex' ),
			'none'    => __( 'None', 'woocommerce-shipping-fedex' ),
		),
	),
	'packing'         => array(
	...
	'smartpost_hub'   => array(
		'title'       => __( 'Fedex Ground Economy Hub', 'woocommerce-shipping-fedex' ),
		'type'        => 'select',
		'description' => __( 'Only required if using Ground Economy.', 'woocommerce-shipping-fedex' ),
		'desc_tip'    => true,
		'default'     => '',
