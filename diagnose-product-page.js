...
async function diagnoseProductPage() {
  ...
  page.on('pageerror', error => {
    ...
    if (error.message.includes('Error #310') || error.message.includes('Maximum update depth exceeded')) {
  ...
  try {
    ...
    if (pageContent.includes('Error #310') || pageContent.includes('Maximum update depth exceeded')) {
