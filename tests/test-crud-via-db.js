...
async function testCRUD() {
  ...
  try {
    ...
    await prisma.quantity.delete({ where: { id: quantity.id } })
    console.log('   ✅ Deleted successfully')
  ...
  if (allTestsPassed) {
    ...
    console.log('✅ Paper Stocks - CRUD Working')
    console.log('✅ Paper Stock Sets - CRUD Working')
    console.log('✅ Quantities - CRUD Working')
    console.log('✅ Sizes - CRUD Working')
    console.log('✅ Add-ons - CRUD Working')
    console.log('✅ Add-on Sets - CRUD Working')
    console.log('✅ Turnaround Times - CRUD Working')
    console.log('✅ Turnaround Time Sets - CRUD Working')
