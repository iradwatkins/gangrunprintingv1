<?php
namespace WCFA\vendor\vanquish\com;

use WCFA\vendor\vanquish\admin\ActivationPage;

class Updater
{
	private $slug = "woocommerce-file-approval";
	private $script_name = "woocommerce-file-approval";
