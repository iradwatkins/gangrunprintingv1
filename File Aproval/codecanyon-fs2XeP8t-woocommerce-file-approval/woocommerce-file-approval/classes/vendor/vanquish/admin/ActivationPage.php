<?php 
namespace WCFA\vendor\vanquish\admin;
	...
	*/
	...
	public function add_page($cap = "manage_woocommerce" )
	{
		...
		if(!$lcfa)
			$this->page = add_submenu_page( null,
											esc_html__($this->plugin_name.' Activator', 'woocommerce-file-approval'), 
											esc_html__($this->plugin_name.' Activator', 'woocommerce-file-approval'), 
											  $cap, 
											  $this->page_slug, 
	...
	public function render_page()
	{
		...
		wp_register_script('vanquish-activator', $this->plugin_path.'/js/vendor/vanquish/activator.js', array('jquery'));
		 $js_settings = array(
				'purchase_code_invalid' => esc_html__( 'Purchase code is invalid!', 'woocommerce-file-approval' ),
				'buyer_invalid' => esc_html__( 'Buyer name is invalid!', 'woocommerce-file-approval' ),
				'item_id_invalid' => esc_html__( 'Item id is invalid!', 'woocommerce-file-approval' ),
				'num_domain_reached' => esc_html__( 'Max number of domains reached! You have to purchase a new license. The current license has been activated in the following domains: ', 'woocommerce-file-approval' ),
				'status_default_message' => esc_html__( 'Verifing, please wait...', 'woocommerce-file-approval' ),
				'db_error' => esc_html__( 'There was an error while verifing the code. Please retry in few minutes!', 'woocommerce-file-approval' ),
				'purchase_code_valid' => esc_html__( 'Activation successfully completed!', 'woocommerce-file-approval' ),
				'empty_fields_error' => esc_html__( 'Buyer and Purchase code fields must be filled!', 'woocommerce-file-approval' ),
		...
		?>
		<div class="wrap">
			<h2><?php esc_html_e($this->plugin_name.' Activator','woocommerce-file-approval'); ?></h2>
	...
	function add_meta_boxes()
	{
		 ...
		 add_meta_box( 'vanquish_activation', 
					__('Activation','woocommerce-file-approval'), 
					...
					<div id="activation_fields_container">
						...
						<div class="fields_blocks_container">
							<div class="inline-container">
								...
								<label><?php esc_html_e( 'Buyer', 'woocommerce-file-approval' ); ?></label>
								<p  class="field_description"><?php esc_html_e( 'Insert the Envato username used to purchase the plugin.', 'woocommerce-file-approval' ); ?></p>
								<input type="text" value="" id="input_buyer" class="input_field" placeholder="<?php esc_html_e( 'Example: vanquish', 'woocommerce-file-approval' ); ?>"></input>
							</div>
							<div class="inline-container">
								<label><?php esc_html_e( 'Purchase code', 'woocommerce-file-approval' ); ?></label>
								<p  class="field_description"><?php esc_html_e( 'Insert the purchase code. It can be downloaded from your CodeCanyon "Downloads" profile page.', 'woocommerce-file-approval' ); ?></p>
								<input type="text" value="" class="input_field" id="input_purchase_code" placeholder="<?php esc_html_e( 'Example: 7d7c3rt8-f512-227c-8c98-fc53c3b212fe', 'woocommerce-file-approval' ); ?>"></input>
							</div>
							<button class="button button-primary" id="activation_button"><?php esc_html_e( 'Activate', 'woocommerce-file-approval' ); ?></button>
						</div>
						<div id="status"><?php esc_html_e( 'Verifing, please wait...', 'woocommerce-file-approval' ); ?></div>
					</div>
				<?php else: ?>
					<p class="activatior_description"><?php esc_html_e( 'The plugin has been successfully activated!', 'woocommerce-file-approval' ); ?></p>
				<?php endif; ?>
			</div>
		<?php
	}
