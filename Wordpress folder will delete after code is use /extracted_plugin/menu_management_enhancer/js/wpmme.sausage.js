...
;(function ($, undefined) {
  $.widget('cc.wpmme_sausage', {
    ...
    _getCurrent: function () {
      ...
      ;((h_win = self.$outer.height()), (h_doc = self.$inner.height()), (i = 0))
    ...
    _delegates: function () {
      ...
      self.$sausages
        .delegate('.sausage', 'mouseenter mouseleave', function () {
          if (self.blocked) {
            return
          }
    ...
    _scrollTo: function (o) {
      o = o - 35 // CJM accommodate wp admin bar
    ...
    _update: function () {
      var self = this
      ;((i = self._getCurrent()), (c = 'sausage-current'))
    ...
    _getHandleHeight: function ($outer, $inner) {
      ...
      var ss_normalize = $('#menu-to-edit').offset().top + 35
    ...
    draw: function () {
      ...
      for (var i = 0; i < self.count; i++) {
        ...
        s.push(
          '<div class="sausage' +
            (i === self.current ? ' sausage-current' : '') +
            '" style="height:' +
            pageheight +
            'px;top:' +
            offset_s +
            'px;">' +
            self.options.content(i, $page) +
            '</div>'
        )
