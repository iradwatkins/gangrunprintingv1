...
function addResponseHeaders(response: NextResponse, correlationId: string) {
  ...
  if (process.env.NODE_ENV === 'production') {
    response.headers.set(
      ...
      "object-src 'none'; base-uri 'self'; form-action 'self' https://www.paypal.com https://geoissuer.cardinalcommerce.com https://songbird.cardinalcommerce.com https://centinelapistag.cardinalcommerce.com; frame-ancestors 'none'; " +
      "frame-src https://web.squarecdn.com https://*.squarecdn.com https://www.paypal.com https://*.paypal.com https://kit.cash.app https://geoissuer.cardinalcommerce.com https://songbird.cardinalcommerce.com https://centinelapistag.cardinalcommerce.com; " +
