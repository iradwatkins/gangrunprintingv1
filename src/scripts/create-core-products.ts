...
const productConfigs: ProductConfig[] = [
  {
    ...
    sku: 'BC-STD-001',
    description: 'Professional business cards with full-color printing on premium card stock. Perfect for networking and making a lasting impression.',
  ...
  },
  {
    ...
    sku: 'BRO-TRI-001',
    description: 'Professional tri-fold brochures for detailed product or service information. High-quality printing on premium paper stock.',
  ...
  },
  {
    ...
    sku: 'PC-MKT-001',
    description: 'Direct mail postcards for targeted marketing campaigns. Full-color printing on premium cardstock.',
  ...
  },
  {
    ...
    sku: 'POS-LRG-001',
    description: 'High-impact posters for displays, events, and advertising. Vivid colors on durable poster stock.',
  ...
  },
  {
    ...
    slug: 'vinyl-banners',
    sku: 'BAN-VIN-001',
    description: 'Durable vinyl banners for indoor and outdoor advertising. Weather-resistant with vibrant colors.',
  ...
  },
  {
    ...
    sku: 'DH-MKT-001',
    description: 'Door hangers for local marketing and service promotions. Full-color printing with custom die-cut.',
