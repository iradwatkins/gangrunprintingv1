...
const categories = [
  ...
  { name: 'Business Card', slug: 'business-card', description: 'Professional business cards', sortOrder: 1 },
  { name: 'Business Card Sharing', slug: 'business-card-sharing', description: 'Digital business card sharing solutions', sortOrder: 2 },
  { name: 'Foil Business Card', slug: 'foil-business-card', description: 'Premium foil-stamped business cards', sortOrder: 3 },
  { name: 'Foldable Business Card', slug: 'foldable-business-card', description: 'Unique foldable business cards', sortOrder: 4 },
  
  // Marketing Materials - Flyers & Postcards
  { name: 'Flyer', slug: 'flyer', description: 'Marketing flyers and handouts', sortOrder: 10 },
  { name: 'Flyer Sharing', slug: 'flyer-sharing', description: 'Shared flyer printing', sortOrder: 11 },
  { name: 'Die Cut Flyer', slug: 'die-cut-flyer', description: 'Custom die-cut flyers', sortOrder: 12 },
  { name: 'Tear Off Flyer', slug: 'tear-off-flyer', description: 'Flyers with tear-off tabs', sortOrder: 13 },
  { name: 'Postcard', slug: 'postcard', description: 'Standard postcards', sortOrder: 14 },
  { name: 'EDDM Postcard', slug: 'eddm-postcard', description: 'Every Door Direct Mail postcards', sortOrder: 15 },
  
  // Brochures & Folded Materials
  { name: 'Brochure', slug: 'brochure', description: 'Tri-fold and bi-fold brochures', sortOrder: 20 },
  ...
  { name: 'Poster - Short Run (1-100)', slug: 'poster-short-run', description: 'Small quantity poster runs', sortOrder: 32 },
  ...
  { name: 'Carbonless Form', slug: 'carbonless-form', description: 'NCR forms and invoices', sortOrder: 43 },
  { name: 'Pocket Folder', slug: 'pocket-folder', description: 'Presentation folders', sortOrder: 44 },
  
  // Cards & Invitations
  { name: 'Greeting Card', slug: 'greeting-card', description: 'Custom greeting cards', sortOrder: 50 },
  ...
  { name: 'Membership Card', slug: 'membership-card', description: 'Plastic membership cards', sortOrder: 53 },
  
  // Marketing Specialties
  { name: 'Door Hanger', slug: 'door-hanger', description: 'Door hanger marketing', sortOrder: 60 },
  { name: 'Rip Door Hanger', slug: 'rip-door-hanger', description: 'Door hangers with tear-off', sortOrder: 61 },
  ...
  { name: 'Drink Coaster', slug: 'drink-coaster', description: 'Custom drink coasters', sortOrder: 84 },
  ...
  // Specialty Items
  { name: 'Rip Card', slug: 'rip-card', description: 'Cards with perforated sections', sortOrder: 90 },
  { name: 'Wrapping Paper', slug: 'wrapping-paper', description: 'Custom wrapping paper', sortOrder: 91 },
]
