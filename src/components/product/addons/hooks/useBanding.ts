...
import { BandingConfig } from '../types/addon.types'
...
export function useBanding(
  ...
  const handleBandingTypeChange = useCallback((value: string) => {
  ...
  const handleItemsPerBundleChange = useCallback((value: number) => {
