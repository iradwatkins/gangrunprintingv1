...
import { Eye, CheckCircle, AlertCircle, Loader2, RefreshCw, Smartphone, Monitor } from 'lucide-react';
            ...
            <CardContent>
              <Alert className="bg-amber-50 border-amber-200">
                ...
                <AlertDescription className="text-amber-700">
                  Review and approve {waitingProofs.length} proof{waitingProofs.length !== 1 ? 's' : ''} below to proceed with production.
                </AlertDescription>
              </Alert>
            </CardContent>
          )}
