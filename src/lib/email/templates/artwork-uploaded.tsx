    ...
    <EmailLayout preview={`New artwork uploaded for Order ${orderNumber}`}>
      ...
      <Section style={mainSection}>
        ...
        <Text style={paragraph}>
          {customerName} has uploaded {fileCount} design file{fileCount !== 1 ? 's' : ''} for their
          order:
        </Text>
        ...
        <Section style={tipBox}>
          ...
          <Text style={tipText}>
            Please review the files promptly so we can get the proof to the customer for approval.
            Fast turnaround time keeps customers happy!
          </Text>
        </Section>
      </Section>
    </EmailLayout>
