    ...
    <html>
      ...
      <body style={{ fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto', padding: '20px' }}>
        ...
        <div style={{ background: '#f97316', padding: '24px', borderRadius: '8px', textAlign: 'center', marginBottom: '24px' }}>
          <h1 style={{ fontSize: '28px', margin: '0 0 16px', color: 'white' }}>🛒 Your Cart is Still Here!</h1>
        ...
        <div style={{ marginBottom: '24px' }}>
          <p style={{ fontSize: '16px', lineHeight: '1.6' }}>
            We noticed you left {items.length} item{items.length > 1 ? 's' : ''} in your cart about {hoursSinceAbandonment} hours ago.
            Your items are still waiting for you!
          </p>

          {couponCode && (
            <div style={{ background: '#fef3c7', padding: '16px', borderRadius: '8px', margin: '20px 0', border: '2px dashed #f59e0b' }}>
              <p style={{ margin: '0 0 8px', fontWeight: 'bold', fontSize: '16px', textAlign: 'center' }}>
                🎉 Complete your order now and save {couponValue}%!
              </p>
              <p style={{ margin: 0, textAlign: 'center', fontSize: '24px', fontWeight: 'bold', color: '#f97316' }}>
                {couponCode}
              </p>
              <p style={{ margin: '8px 0 0', fontSize: '12px', textAlign: 'center', color: '#737373' }}>
                Expires in 7 days
              </p>
            </div>
          )}
        ...
        <div style={{ background: '#f9fafb', padding: '20px', borderRadius: '8px', marginBottom: '24px' }}>
          ...
          {items.map((item, index) => (
            <div key={index} style={{ marginBottom: '12px', paddingBottom: '12px', borderBottom: index < items.length - 1 ? '1px solid #e5e7eb' : 'none' }}>
          ...
          <div style={{ marginTop: '16px', paddingTop: '16px', borderTop: '2px solid #e5e7eb' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <span style={{ fontSize: '16px', fontWeight: 'bold', color: '#f97316' }}>{formatPrice(total)}</span>
            </div>
          </div>
        </div>
        ...
        {/* Why Choose Us */}
        <div style={{ background: '#f9fafb', padding: '20px', borderRadius: '8px', marginBottom: '24px' }}>
          <h3 style={{ fontSize: '16px', margin: '0 0 12px' }}>Why GangRun Printing?</h3>
