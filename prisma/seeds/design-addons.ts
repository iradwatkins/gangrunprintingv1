  ...
  const designAddons = [
    ...
    },
    {
      ...
      configuration: {
        ...
        sideOptions: {
          oneSide: { price: 90.00, label: 'One Side' },
          twoSides: { price: 135.00, label: 'Two Sides' }
        }
      },
    ...
    },
    {
      ...
      configuration: {
        requiresSideSelection: true,
        sideOptions: {
          oneSide: { price: 160.00, label: 'One Side' },
          twoSides: { price: 240.00, label: 'Two Sides' }
        }
      },
  ...
  for (const addOnId of designWithSides) {
    ...
    await prisma.addOnSubOption.upsert({
      ...
      update: {
        ...
        options: {
          choices: [
            { value: 'oneSide', label: 'One Side', price: addon.configuration.sideOptions.oneSide.price },
            { value: 'twoSides', label: 'Two Sides', price: addon.configuration.sideOptions.twoSides.price }
          ]
        },
        isRequired: true,
        affectsPricing: true,
