...
async function main() {
  ...
  const addOns = [
    ...
    // 5. Folding - Complex pricing based on paper type
    {
      ...
      isActive: true,
      adminNotes:
        'Text Paper: $0.17 + $0.01/piece. Card Stock: $0.34 + $0.02/piece (includes mandatory basic score). Min print size 5x6.',
    },
    // 6. Design Services - Multi-tier pricing
    {
      ...
      configuration: {
        ...
        minorChanges: { price: 22.5, turnaroundHours: 24 },
        majorChanges: { price: 45.0, turnaroundHours: 48 },
      },
      additionalTurnaroundDays: 0,
      sortOrder: 6,
      isActive: true,
