    ...
    const productsToCreate = [
      {
        ...
        description: 'High-quality business cards printed on premium cardstock with your choice of finishes. Perfect for making a professional first impression. Available in multiple paper stocks and sizes.',
      ...
      },
      {
        ...
        description: 'Eye-catching full-color flyers perfect for promotions, events, and marketing campaigns. High-quality printing on various paper stocks with multiple size options.',
      ...
      },
      {
        ...
        description: 'Professional glossy postcards ideal for direct mail campaigns, promotional mailings, and announcements. High-impact printing with vibrant colors.',
      ...
      },
      {
        ...
        description: 'High-impact large format posters perfect for events, trade shows, retail displays, and advertising. Professional quality printing with vibrant colors and sharp details.',
      ...
      },
      {
        ...
        description: 'Custom die-cut stickers with precise cutting and vibrant colors. Perfect for branding, promotions, and personal use. Durable vinyl material with strong adhesive.',
