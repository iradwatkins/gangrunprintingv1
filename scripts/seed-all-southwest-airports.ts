...
const airports = [
  ...
  },
  {
    ...
    carrier: 'SOUTHWEST_CARGO',
    operator: null,
    address: 'Airport Terminal Services',
    city: 'Ft. Myers',
    state: 'FL',
    zip: '33913',
    hours: {
  ...
  },
  {
    ...
    carrier: 'SOUTHWEST_CARGO',
    operator: null,
    address: 'Gerald Ford International Airport',
    city: 'Grand Rapids',
    state: 'MI',
    zip: '49512',
    hours: {
...
async function main() {
  console.log('🛫 Seeding all 72 Southwest Cargo airport locations...')
