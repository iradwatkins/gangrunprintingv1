...
async function seedPaperStocks() {
  ...
  const paperStocks = [
    ...
    { name: '14pt Cardstock', category: 'Premium', coating: 'Uncoated', weight: '14pt', pricePerSqInch: 0.0015, costPerSheet: 0.08, finish: 'Matte', thickness: 0.014, sides: 'Double' },
    { name: '16pt Cardstock', category: 'Premium', coating: 'C2S', weight: '16pt', pricePerSqInch: 0.0018, costPerSheet: 0.10, finish: 'Gloss', thickness: 0.016, sides: 'Double' },
    { name: '32pt Triple Layer', category: 'Luxury', coating: 'Soft Touch', weight: '32pt', pricePerSqInch: 0.0045, costPerSheet: 0.25, finish: 'Soft Touch', thickness: 0.032, sides: 'Double' },
    { name: 'Silk Laminated 16pt', category: 'Luxury', coating: 'Silk', weight: '16pt', pricePerSqInch: 0.0035, costPerSheet: 0.20, finish: 'Silk', thickness: 0.018, sides: 'Double' },
    
    // Standard Papers
    { name: '100lb Gloss Text', category: 'Standard', coating: 'Gloss', weight: '100lb', pricePerSqInch: 0.0008, costPerSheet: 0.05, finish: 'Gloss', thickness: 0.008, sides: 'Double' },
    { name: '100lb Matte Text', category: 'Standard', coating: 'Matte', weight: '100lb', pricePerSqInch: 0.0008, costPerSheet: 0.05, finish: 'Matte', thickness: 0.008, sides: 'Double' },
    { name: '70lb Uncoated Text', category: 'Economy', coating: 'None', weight: '70lb', pricePerSqInch: 0.0005, costPerSheet: 0.03, finish: 'Uncoated', thickness: 0.006, sides: 'Double' },
    { name: '80lb Gloss Cover', category: 'Standard', coating: 'Gloss', weight: '80lb', pricePerSqInch: 0.0010, costPerSheet: 0.06, finish: 'Gloss', thickness: 0.010, sides: 'Double' },
    { name: '80lb Matte Cover', category: 'Standard', coating: 'Matte', weight: '80lb', pricePerSqInch: 0.0010, costPerSheet: 0.06, finish: 'Matte', thickness: 0.010, sides: 'Double' },
    
    // Specialty Papers
    { name: 'Kraft Paper', category: 'Specialty', coating: 'None', weight: '18pt', pricePerSqInch: 0.0020, costPerSheet: 0.12, finish: 'Natural', thickness: 0.018, sides: 'Double', isEcoFriendly: true },
    { name: 'Recycled Matte', category: 'Eco-Friendly', coating: 'None', weight: '14pt', pricePerSqInch: 0.0016, costPerSheet: 0.09, finish: 'Matte', thickness: 0.014, sides: 'Double', isEcoFriendly: true },
    { name: 'Pearl Metallic', category: 'Luxury', coating: 'Metallic', weight: '16pt', pricePerSqInch: 0.0040, costPerSheet: 0.22, finish: 'Metallic', thickness: 0.016, sides: 'Double' },
    { name: 'Linen Textured', category: 'Premium', coating: 'None', weight: '14pt', pricePerSqInch: 0.0025, costPerSheet: 0.14, finish: 'Textured', thickness: 0.014, sides: 'Double' },
    
    // Large Format Papers
    { name: 'Photo Paper Glossy', category: 'Photo', coating: 'Glossy', weight: '10mil', pricePerSqInch: 0.0012, costPerSheet: 0.15, finish: 'High Gloss', thickness: 0.010, sides: 'Single' },
    { name: 'Canvas Material', category: 'Large Format', coating: 'Matte', weight: '21mil', pricePerSqInch: 0.0050, costPerSheet: 0.45, finish: 'Canvas', thickness: 0.021, sides: 'Single' },
    { name: '13oz Vinyl Banner', category: 'Large Format', coating: 'None', weight: '13oz', pricePerSqInch: 0.0030, costPerSheet: 0.35, finish: 'Matte', thickness: 0.015, sides: 'Single' },
    { name: '18oz Heavy Duty Vinyl', category: 'Large Format', coating: 'None', weight: '18oz', pricePerSqInch: 0.0040, costPerSheet: 0.50, finish: 'Matte', thickness: 0.020, sides: 'Single' },
    
    // Sticker Materials
    { name: 'White Vinyl Sticker', category: 'Stickers', coating: 'Gloss', weight: '4mil', pricePerSqInch: 0.0025, costPerSheet: 0.08, finish: 'Gloss', thickness: 0.004, sides: 'Single' },
    { name: 'Clear Vinyl Sticker', category: 'Stickers', coating: 'Gloss', weight: '4mil', pricePerSqInch: 0.0030, costPerSheet: 0.10, finish: 'Clear', thickness: 0.004, sides: 'Single' },
    { name: 'Holographic Sticker', category: 'Stickers', coating: 'Holographic', weight: '4mil', pricePerSqInch: 0.0050, costPerSheet: 0.15, finish: 'Holographic', thickness: 0.004, sides: 'Single' }
  ]
...
async function seedCategories() {
  ...
  const categories = [
    { id: 'business-cards', name: 'Business Cards', slug: 'business-cards', description: 'Professional business cards in various styles', sortOrder: 1 },
    { id: 'flyers', name: 'Flyers & Brochures', slug: 'flyers', description: 'Marketing flyers and brochures', sortOrder: 2 },
    { id: 'postcards', name: 'Postcards', slug: 'postcards', description: 'Direct mail and promotional postcards', sortOrder: 3 },
    { id: 'posters', name: 'Posters', slug: 'posters', description: 'Large format posters', sortOrder: 4 },
    { id: 'banners', name: 'Banners & Signs', slug: 'banners', description: 'Indoor and outdoor signage', sortOrder: 5 },
    { id: 'stickers', name: 'Stickers & Labels', slug: 'stickers', description: 'Custom stickers and labels', sortOrder: 6 },
    { id: 'apparel', name: 'Apparel', slug: 'apparel', description: 'Custom printed clothing', sortOrder: 7 },
    { id: 'marketing', name: 'Marketing Materials', slug: 'marketing', description: 'Various marketing materials', sortOrder: 8 },
    { id: 'packaging', name: 'Packaging', slug: 'packaging', description: 'Custom packaging solutions', sortOrder: 9 },
    { id: 'large-format', name: 'Large Format', slug: 'large-format', description: 'Wide format printing', sortOrder: 10 }
  ]
...
async function seedSidesAndCoatings() {
  ...
  // Sides options
  const sidesOptions = [
    { name: 'Single Sided (4/0)', code: '4/0', description: 'Full color front, blank back', isDefault: false },
    { name: 'Double Sided (4/4)', code: '4/4', description: 'Full color both sides', isDefault: true },
    { name: 'Front Color, Back B&W (4/1)', code: '4/1', description: 'Full color front, black & white back', isDefault: false },
    { name: 'Black & White Both Sides (1/1)', code: '1/1', description: 'Black & white both sides', isDefault: false }
  ]
  ...
  const coatingOptions = [
    ...
    { name: 'Aqueous Coating', description: 'Water-based protective coating', additionalCost: 0.0003 }
  ]
  ...
  console.log(`✅ Created ${sidesOptions.length} sides options and ${coatingOptions.length} coating options`)
}
